...
const app = express(); // tạo bằng cách gọi express()
app.use(express.json()); // giúp ứng dụng xử lý dữ liệu JSON được gửi từ client trong các yêu cầu HTTP

// Định nghĩa route và logic kiểm thử cho ứng dụng
const names = []; // khởi tạo mảng names để lưu các tên đã gửi
